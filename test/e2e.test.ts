...
for (const protocol of ["http", "https"] as const) {
  test(`node ${protocol} proxy timeouts follow the request selected from the pool`, { timeout: 10_000 }, async () => {
