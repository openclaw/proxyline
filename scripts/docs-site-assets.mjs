...
:root[data-theme="dark"] .home-cta .btn-primary{color:#04111a}
:root[data-theme="dark"] .home-cta .btn-primary:hover{color:#04111a}
...
export function brandMarkSvg() {
  ...
  <path d="M5 6 L11 12 L5 18 M11 6 L17 12 L11 18" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/>
</svg>`;
}

export function faviconSvg() {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" role="img" aria-label="proxyline">
  <rect width="64" height="64" rx="12" fill="#0b1220"/>
  <path d="M18 18 L30 32 L18 46 M30 18 L42 32 L30 46" fill="none" stroke="#22d3ee" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/>
</svg>`;
}
