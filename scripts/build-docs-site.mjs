...
const repoBase = "https://github.com/openclaw/proxyline";
...
const sections = [
  ["Start", ["README.md", "getting-started.md"]],
  ["Concepts", ["modes.md", "surfaces.md", "environment-variables.md"]],
  ["Configuration", ["proxy-tls.md", "observability.md"]],
  ["Operations", ["security.md", "troubleshooting.md", "testing.md"]],
...
function docsOrigin() {
  const value = (typeof siteBase !== "undefined" && siteBase) || "";
...
function homeHero(page) {
  ...
  const quickstartRel = pageMap.get("getting-started.md")?.outRel
    ? hrefToOutRel(pageMap.get("getting-started.md").outRel, page.outRel)
...
<body${home ? ' class="home"' : ""}>
  ...
  <div class="shell">
    <aside class="sidebar">
      ...
      <label class="search"><span>Search</span><input id="doc-search" type="search" placeholder="modes, websocket, connect…"></label>
...
function navTitle(page) {
  if (page.rel === "README.md" || page.rel === "index.md") return "Overview";
  return page.title;
}
